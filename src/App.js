...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1657.59;
    const TROY_OZT_USD_SILVER = 14.910;
    const TROY_OZT_USD_PLATINUM = 738.24;
    const BITCOIN_USD = 7200.87;
    const ETHEREUM_USD = 164.40;
    const DOGECOIN_USD = 0.0019476;
    const KGC_USD = 5.08;
    const NEM_USD = 50.62;
