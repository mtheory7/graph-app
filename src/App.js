...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1573.53;
    const TROY_OZT_USD_SILVER = 17.706;
    const TROY_OZT_USD_PLATINUM = 966.66;
    const BITCOIN_USD = 9884.89;
    const ETHEREUM_USD = 223.68;
    const DOGECOIN_USD = 0.00296641;
