...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1673.30;
    const TROY_OZT_USD_SILVER = 17.344;
    const TROY_OZT_USD_PLATINUM = 900.00;
    const BITCOIN_USD = 9099.49;
    const ETHEREUM_USD = 243.30;
    const DOGECOIN_USD = 0.00245567;
    const TWITTER_USD = 33.46;
    const GE_USD = 9.40;
    const KGC_USD = 5.57;
    const NEM_USD = 52.35;
