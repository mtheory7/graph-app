...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1744.20;
    const TROY_OZT_USD_SILVER = 17.324;
    const TROY_OZT_USD_PLATINUM = 838.40;
    const BITCOIN_USD = 9516.99;
    const ETHEREUM_USD = 210.39;
    const DOGECOIN_USD = 0.00250740;
    const KGC_USD = 7.34;
    const NEM_USD = 65.72;
