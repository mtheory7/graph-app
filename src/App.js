...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1619.09;
    const TROY_OZT_USD_SILVER = 14.399;
    const TROY_OZT_USD_PLATINUM = 719.80;
    const BITCOIN_USD = 6755.66;
    const ETHEREUM_USD = 140.95;
    const DOGECOIN_USD = 0.0018417;
    const KGC_USD = 5.05;
    const NEM_USD = 49.06;
