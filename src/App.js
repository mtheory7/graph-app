...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1480.44;
    const TROY_OZT_USD_SILVER = 12.342;
    const TROY_OZT_USD_PLATINUM = 605.70;
    const BITCOIN_USD = 6218.85;
    const ETHEREUM_USD = 134.47;
    const DOGECOIN_USD = 0.00180228;
    const TWITTER_USD = 24.49;
    const GE_USD = 6.56;
    const KGC_USD = 3.73;
    const NEM_USD = 39.32;
