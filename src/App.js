...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1729.33;
    const TROY_OZT_USD_SILVER = 17.852;
    const TROY_OZT_USD_PLATINUM = 838.25;
    const BITCOIN_USD = 9484.77;
    const ETHEREUM_USD = 234.35;
    const DOGECOIN_USD = 0.0025775;
    const KGC_USD = 6.55;
    const NEM_USD = 58.47;
