...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1866.44;
    const TROY_OZT_USD_SILVER = 22.916;
    const TROY_OZT_USD_PLATINUM = 913.16;
    const BITCOIN_USD = 9370.27;
    const ETHEREUM_USD = 244.87;
    const DOGECOIN_USD = 0.0032426;
    const KGC_USD = 8.43;
    const NEM_USD = 65.15;
