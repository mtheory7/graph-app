...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1798.38;
    const TROY_OZT_USD_SILVER = 18.740;
    const TROY_OZT_USD_PLATINUM = 826.00;
    const BITCOIN_USD = 9285.88;
    const ETHEREUM_USD = 240.12;
    const DOGECOIN_USD = 0.0036236;
    const KGC_USD = 7.63;
    const NEM_USD = 61.88;
