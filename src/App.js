...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1498.70;
    const TROY_OZT_USD_SILVER = 12.612;
    const TROY_OZT_USD_PLATINUM = 608.50;
    const BITCOIN_USD = 6099.46;
    const ETHEREUM_USD = 131.03;
    const DOGECOIN_USD = 0.00171045;
