...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1657.08;
    const TROY_OZT_USD_SILVER = 17.277;
    const TROY_OZT_USD_PLATINUM = 865.18;
    const BITCOIN_USD = 9055.58;
    const ETHEREUM_USD = 230.18;
    const DOGECOIN_USD = 0.00253423;
    const TWITTER_USD = 35.48;
    const GE_USD = 10.50;
    const KGC_USD = 5.52;
    const NEM_USD = 50.65;
