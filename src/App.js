...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1518.45;
    const TROY_OZT_USD_SILVER = 12.848;
    const TROY_OZT_USD_PLATINUM = 625.55;
    const BITCOIN_USD = 6353.02;
    const ETHEREUM_USD = 132.96;
    const DOGECOIN_USD = 0.00178056;
    const TWITTER_USD = 23.95;
    const GE_USD = 6.52;
    const KGC_USD = 3.61;
    const NEM_USD = 40.56;
