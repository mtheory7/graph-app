...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1691.97;
    const TROY_OZT_USD_SILVER = 14.902;
    const TROY_OZT_USD_PLATINUM = 766.44;
    const BITCOIN_USD = 8849.70;
    const ETHEREUM_USD = 212.42;
    const DOGECOIN_USD = 0.0023993;
    const KGC_USD = 6.67;
    const NEM_USD = 60.03;
