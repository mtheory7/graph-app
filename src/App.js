...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1601.28;
    const TROY_OZT_USD_SILVER = 16.779;
    const TROY_OZT_USD_PLATINUM = 866.90;
    const BITCOIN_USD = 8785.72;
    const ETHEREUM_USD = 228.28;
    const DOGECOIN_USD = 0.00246045;
    const TWITTER_USD = 35.82;
    const GE_USD = 11.21;
    const KGC_USD = 5.29;
    const NEM_USD = 46.83;
