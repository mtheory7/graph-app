...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1529.71;
    const TROY_OZT_USD_SILVER = 14.746;
    const TROY_OZT_USD_PLATINUM = 759.00;
    const BITCOIN_USD = 5209.61;
    const ETHEREUM_USD = 122.86;
    const DOGECOIN_USD = 0.00166657;
    const TWITTER_USD = 29.29;
    const GE_USD = 7.85;
    const KGC_USD = 3.47;
    const NEM_USD = 39.50;
