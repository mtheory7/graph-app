...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1684.84;
    const TROY_OZT_USD_SILVER = 17.296;
    const TROY_OZT_USD_PLATINUM = 814.18;
    const BITCOIN_USD = 9698.58;
    const ETHEREUM_USD = 242.36;
    const DOGECOIN_USD = 0.0025805;
    const KGC_USD = 6.32;
    const NEM_USD = 55.90;
