...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1727.40;
    const TROY_OZT_USD_SILVER = 15.204;
    const TROY_OZT_USD_PLATINUM = 759.75;
    const BITCOIN_USD = 7546.20;
    const ETHEREUM_USD = 194.49;
    const DOGECOIN_USD = 0.0020956;
    const KGC_USD = 7.09;
    const NEM_USD = 63.11;
