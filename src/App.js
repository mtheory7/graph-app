...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1738.42;
    const TROY_OZT_USD_SILVER = 15.836;
    const TROY_OZT_USD_PLATINUM = 777.59;
    const BITCOIN_USD = 6954.61;
    const ETHEREUM_USD = 160.49;
    const DOGECOIN_USD = 0.0019658;
    const KGC_USD = 6.22;
    const NEM_USD = 60.28;
