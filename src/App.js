...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1641.27;
    const TROY_OZT_USD_SILVER = 14.551;
    const TROY_OZT_USD_PLATINUM = 730.18;
    const BITCOIN_USD = 7156.58;
    const ETHEREUM_USD = 156.90;
    const DOGECOIN_USD = 0.0019231;
    const KGC_USD = 4.86;
    const NEM_USD = 47.15;
