...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1599.50;
    const TROY_OZT_USD_SILVER = 13.828;
    const TROY_OZT_USD_PLATINUM = 683.89;
    const BITCOIN_USD = 6619.63;
    const ETHEREUM_USD = 137.72;
    const DOGECOIN_USD = 0.00185344;
    const TWITTER_USD = 24.69;
    const GE_USD = 6.11;
    const KGC_USD = 3.95;
    const NEM_USD = 41.66;
