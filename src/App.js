...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1679.63;
    const TROY_OZT_USD_SILVER = 17.030;
    const TROY_OZT_USD_PLATINUM = 866.71;
    const BITCOIN_USD = 7796.77;
    const ETHEREUM_USD = 195.60;
    const DOGECOIN_USD = 0.00210467;
    const TWITTER_USD = 33.06;
    const GE_USD = 8.24;
    const KGC_USD = 5.26;
    const NEM_USD = 48.15;
