...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1691.20;
    const TROY_OZT_USD_SILVER = 17.500;
    const TROY_OZT_USD_PLATINUM = 828.98;
    const BITCOIN_USD = 9698.11;
    const ETHEREUM_USD = 242.66;
    const DOGECOIN_USD = 0.0025664;
    const KGC_USD = 6.17;
    const NEM_USD = 55.39;
