...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1733.31;
    const TROY_OZT_USD_SILVER = 17.036;
    const TROY_OZT_USD_PLATINUM = 819.89;
    const BITCOIN_USD = 9722.34;
    const ETHEREUM_USD = 214.41;
    const DOGECOIN_USD = 0.0025429;
    const KGC_USD = 7.05;
    const NEM_USD = 66.26;
