...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1727.06;
    const TROY_OZT_USD_SILVER = 17.526;
    const TROY_OZT_USD_PLATINUM = 828.62;
    const BITCOIN_USD = 9411.08;
    const ETHEREUM_USD = 232.04;
    const DOGECOIN_USD = 0.0024600;
    const KGC_USD = 6.36;
    const NEM_USD = 56.26;
