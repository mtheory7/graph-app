...
function App() {
    ...
    // Prices
    const TROY_OZT_USD_GOLD = 1694.90;
    const TROY_OZT_USD_SILVER = 15.404;
    const TROY_OZT_USD_PLATINUM = 745.80;
    const BITCOIN_USD = 6871.30;
    const ETHEREUM_USD = 157.64;
    const DOGECOIN_USD = 0.0019228;
    const KGC_USD = 5.62;
    const NEM_USD = 57.32;
